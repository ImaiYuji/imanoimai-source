...
| モデル | なるかでぃあ県 |
| 衣装 | てんぱすおおもり |
| ポーズ | UniSakiStudio 可愛いポーズツール |
| このアプリ | お兄ちゃん（X [@26KC1011](https://x.com/26KC1011)） |

2 体目の「ダーク今井ちゃん」は、なるかでぃあ県さんのモデルに
てんぱすおおもりさんの衣装を合わせたものです。

キャラクターのモデルとポーズは、それぞれの作者の利用規約にしたがって
アプリに組み込んで配布しています。**このリポジトリには含めていません。**
可愛いポーズツールの規約は未改変での再配布を認めていないためです。
